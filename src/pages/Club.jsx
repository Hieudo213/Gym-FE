        ...
        <>
            ...
            <section className="bg-[#fef8fa] pb-[84px]">
                <div className="flex flex-col justify-center items-center pt-[60px] pb-[30px]">
                    ...
                    <form action="">
                        <select
                            className="text-left w-[360px] py-3 px-4 pr-10 appearance-none bg-[url('https://upload.wikimedia.org/wikipedia/commons/9/9d/Caret_down_font_awesome_whitevariation.svg')] bg-[length:20px_20px] focus:outline-none">
