    ...
    <>
      ...
      <div className="mt-[15rem]">
        ...
        <section className="w-4/5 mx-auto grid grid-cols-4 gap-8 mt-10 pb-5">
          ...
          <div className="relative w-full   group  cursor-pointer">
            <img
              src="https://citigym.com.vn/themes/citigym/images/features/feature-1.jpg"
              alt=""
              className="w-full h-20rem transition-opacity duration-500 group-hover:opacity-50"
            />
            <div className="  absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
          ...
          <div className="relative w-full   group  cursor-pointer">
            <img
              src="https://citigym.com.vn/themes/citigym/images/features/feature-3.jpg"
              alt=""
              className="w-full h-20rem transition-opacity duration-500 group-hover:opacity-50"
            />
            <div className="  absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
          ...
          <div className="relative w-full   group  cursor-pointer">
            <img
              src="https://citigym.com.vn/themes/citigym/images/features/feature-4.jpg"
              alt=""
              className="w-full h-20rem transition-opacity duration-500 group-hover:opacity-50"
            />
            <div className="  absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
      ...
      <section className="w-full py-5 h-[60rem]  img_bg   relative">
        ...
        <div className="relative z-10 text-center my-10 ">
          ...
          <p className="w-[40%] mx-auto my-5">
            Với chuỗi hoạt động liên tục, Kickfit đem lại vẻ săn chắc đặc biệt
            là phần bụng; giúp vóc dáng thon gọn nhanh nhất; giảm căng thẳng,
            tốt cho thể chất và tinh thần; nâng cao khả năng tự vệ; rèn luyện
            phản xạ và tính kỷ luật.
          </p>
        </div>
